...
def get_args():
    ...
    parser.add_argument('--data_path', type=str,
                        default='/home/stein/Documents/chemical_reaction_data/synthesis_reaction/useful_data/rotnet',
                        help='data_path')
    parser.add_argument('--save_path', type=str,
                        default='rotnet_models',
                        help='save_path')
    parser.add_argument('--model_name', type=str, default="rotnet.h5")
...
class Rollout_Network(object):
    ...
    def fit(self, data_path = None, file_indexes = (0,1,2,3,4), save_path = "saved_model", model_name = "rotnet.h5",
...
if __name__ == "__main__":
    ...
    lbl = LabelEncoder()
    try:
        lbl.classes_ = np.load(args.data_path+'/rotnet_relabel.npy')
    except:
        print("No previous relabelor exists, creating one from scratch")
        all_labels = lbl.fit_transform(all_labels)
        np.save(args.data_path + "/rotnet_relabel.npy", lbl.classes_)
    ...
    rotnet = Rollout_Network(n_classes=num_classes, n_feats=10000)
    rotnet.fit_generator(data_path=args.data_path,
